...
# Menu bar: hide the Bluetooth, Time Machine and User icons
...
# Wipe all (default) app icons from the Dock; this is only really useful when setting up a new Mac
...
# Move the dock to the left-side of screen
